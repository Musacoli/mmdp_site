...
const mapStateToProps = (state) => ({
  pillars: state.pillarTwoReducer,
});

const mapDispatchToProps = {
  createPillar: pillarMessageRequest.createPillarTwo,
  updatePillar: pillarMessageRequest.updatePillarTwo,
  getPillar: pillarMessageRequest.getPillarTwo,
};
