...
import * as pillarMessageRequest from '../../store/actions/pillar/pillar';
...
export class PillarOne extends Component {
  state = {
    title: '',
    introduction: '',
    whatWeAreDoing: '',
...
const mapStateToProps = (state) => ({
  pillars: state.pillarOneReducer,
});

const mapDispatchToProps = {
  createPillar: pillarMessageRequest.createPillarOne,
  updatePillar: pillarMessageRequest.updatePillarOne,
  getPillar: pillarMessageRequest.getPillarOne,
};
