...
export class PillarFour extends Component {
  state = {
    title: '',
    introduction: '',
    whatWeAreDoing: '',
...
const mapStateToProps = (state) => ({
  pillars: state.pillarFourReducer,
});

const mapDispatchToProps = {
  createPillar: pillarMessageRequest.createPillarFour,
  updatePillar: pillarMessageRequest.updatePillarFour,
  getPillar: pillarMessageRequest.getPillarFour,
};
